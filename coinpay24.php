...
class CoinPay24 extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->description = $this->l('Accept cryptocurrency payments via CoinPay24.');
    ...
    public function hookPaymentOptions($params)
    {
        ...
        $newOption->setCallToActionText($this->l('Pay with CoinPay24'))
            ...
            ->setAdditionalInformation($this->context->smarty->fetch('module:coinpay24/views/templates/front/payment_info.tpl'));
    ...
    public function hookPaymentReturn($params)
    {
        ...
        return $this->fetch('module:coinpay24/views/templates/front/payment_return.tpl');
    }
}
?>
